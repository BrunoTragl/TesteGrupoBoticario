using BrunoTragl.TesteGrupoBoticario.Web.WebApi;
    ...
    public abstract class WebApiBase
    {
        ...
        protected virtual HttpClient CreateServerAndClient()
        {
            _configuration = new ConfigurationBuilder()
                            .SetBasePath(@"C:\teste-boticario\BrunoTragl.TesteGrupoBoticario.Web.WebApi\BrunoTragl.TesteGrupoBoticario.Web.WebApi2")
